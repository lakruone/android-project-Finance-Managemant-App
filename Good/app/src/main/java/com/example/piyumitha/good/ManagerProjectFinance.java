...
public class ManagerProjectFinance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_project_finance);
        ...
        AddFinance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckEditTextIsNotEmpty()) {
                    ...
                    Toast.makeText(ManagerProjectFinance.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
                }
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            if (dataRequest.statusCode == 200 || dataRequest.statusCode == 304) {
                                try {
                                    new AlertDialog.Builder(ManagerProjectFinance.this)
                                            .setTitle("Success")
